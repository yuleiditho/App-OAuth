...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col relative">
            ...
            <nav class="flex items-center justify-end gap-4">
                ...
                @else
                    ...
                    <a href="{{ route('auth.google.redirect') }}"
                        class="px-5 py-2 flex items-center gap-3 border border-gray-300 dark:border-gray-600 rounded-lg 
                                                                                      bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium 
                                                                                      hover:bg-gray-100 dark:hover:bg-gray-700 hover:shadow-md transition duration-200 ease-in-out">

                        <img class="w-6 h-6" src="https://www.svgrepo.com/show/475656/google-color.svg" loading="lazy"
                            alt="google logo">

                        <span class="text-gray-700 dark:text-gray-200">Google</span>
                    </a>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-8 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">

                <h1
                    class="text-xl lg:text-xl xl:text-5xl font-bold text-white dark:text-white mb-4 lg:mb-6 leading-[1.2]">
                    Dev-Space
                </h1>

                <div class="space-y-2 mb-6 lg:mb-8">
                    <span
                        class="block text-xl lg:text-2xl xl:text-[1.75rem] font-semibold text-[#3b82f6] dark:text-[#60a5fa] leading-snug">
                        App Development
                    </span>
                    <span
                        class="block text-xl lg:text-2xl xl:text-[1.75rem] font-semibold text-[#8b5cf6] dark:text-[#a78bfa] leading-snug">
                        Consultant Services
                    </span>
                </div>
                ...
                <div class="mb-8 lg:mb-10">
                    <p
                        class="text-base lg:text-[1.125rem] xl:text-[1.25rem] text-gray-300 dark:text-white/90 leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore quisquam eaque cupiditate
                        doloribus modi optio natus praesentium dolorum, rem suscipit. We transform your ideas into
                        powerful
                        digital solutions.
                    </p>
                </div>
            ...
            <div
                class="bg-[#f8f9fa] dark:bg-[#0a0a0a] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                <!-- Contenedor de imagen -->
                <div class="relative w-full h-full">
                    <!-- Gradiente de fondo -->
                    <div
                        class="absolute -inset-4 bg-gradient-to-r from-[#3b82f6]/15 to-[#8b5cf6]/15 rounded-full blur-xl">
                    </div>

                    <!-- Imagen -->
                    <div class="relative w-full h-full flex items-center justify-center p-6 lg:p-8">
                        <div class="relative rounded-2xl shadow-2xl overflow-hidden w-full h-full max-w-[500px]">
                            <img src="https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/77311/galaxy-clipart-md.png"
    ...
    <footer class="w-full mt-auto py-6">
        <div class="flex flex-col items-center text-center">
            <div class="text-gray-600 dark:text-white/70 text-[0.9rem] lg:text-base mb-1 tracking-wide">
                &copy; {{ date('Y') }}.
                <span class="font-semibold text-[#3b82f6] dark:text-[#60a5fa] ml-1">@yuleiditho</span>
                | All rights reserved
            </div>
        </div>
    </footer>
